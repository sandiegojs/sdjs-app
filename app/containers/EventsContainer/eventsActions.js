...
export function addAttendeeToEvent(eventObj, userId) {
    return {
        ...
        payload:
        axios
            .post('http://f5f990cc.ngrok.io/checkin', { eventObj, userId })
            .then(response => {
                return response.data;
            })
...
export function profileQuery(userId, token) {
    return {
        ...
        payload:
        axios
            .get('http://f5f990cc.ngrok.io/api/users/' + userId, {headers: {Authorization: token}})
            .then(response => {
                return response.data
            })
            .catch(error => {
...
export function removeAttendee(attendeeId, token) {
    return {
        ...
        payload:
        axios
            .delete('http://f5f990cc.ngrok.io/api/attendees/' + attendeeId, {headers: {Authorization: token}})
            .then(response => {
                return response.data;
            })
            .catch(error => {
...
export function addRSVPToEvent(eventObj, userId) {
    return {
        ...
        payload:
        axios
            .post('http://f5f990cc.ngrok.io/rsvp', { eventObj, userId })
            .then(response => {
...
export function removeRSVPFromEvent(rsvpEventId, token) {
    return {
        ...
        payload:
        axios
            .delete('http://f5f990cc.ngrok.io/api/rsvps/' + rsvpEventId, {header: {Authorization: token}})
            .then(response => {
                return response.data;
            })
            .catch(error => {
...
export function updateRSVPList(user, token) {
    return {
        ...
        payload:
        axios
            .get('http://f5f990cc.ngrok.io/api/rsvps?filter[where][userId]=' + user, {headers: {Authorization: token}})
            .then(response => {
