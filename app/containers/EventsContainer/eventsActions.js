...
export function addAttendeeToEvent(eventObj, userId) {
  return {
    ...
    payload:
      axios
        .post('https://a7e99c18.ngrok.io/checkin', { eventObj, userId })
        .then(response => {
...
export function profileQuery(userId, token) {
  return {
    ...
    payload:
      axios
        .get('https://a7e99c18.ngrok.io/api/users/' + userId, { headers: { Authorization: token } })
        .then(response => {
          return response.data
        })
        .catch(error => {
...
export function removeAttendee(attendeeId, token) {
  return {
    ...
    payload:
      axios
        .delete('https://a7e99c18.ngrok.io/api/attendees/' + attendeeId, { headers: { Authorization: token } })
        .then(response => {
          return response.data;
        })
        .catch(error => {
...
export function addRSVPToEvent(eventObj, userId) {
  return {
    ...
    payload:
      axios
        .post('https://a7e99c18.ngrok.io/rsvp', { eventObj, userId })
        .then(response => {
...
export function removeRSVPFromEvent(rsvpEventId, token) {
  return {
    ...
    payload:
      axios
        .delete('https://a7e99c18.ngrok.io/api/rsvps/' + rsvpEventId, { header: { Authorization: token } })
        .then(response => {
          return response.data;
        })
        .catch(error => {
...
export function updateRSVPList(user, token) {
  return {
    ...
    payload:
      axios
        .get('https://a7e99c18.ngrok.io/api/rsvps?filter[where][userId]=' + user, { headers: { Authorization: token } })
        .then(response => {
